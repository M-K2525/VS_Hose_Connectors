...
public class ElectricMagnetWireConnectorRenderer implements BlockEntityRenderer<ElectricMagnetWireConnectorBlockEntity> {
    ...
    @Override
    public void render(ElectricMagnetWireConnectorBlockEntity be, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
